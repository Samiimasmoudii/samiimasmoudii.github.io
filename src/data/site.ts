...
export const site: Site = {
  ...
  bio: [
    "I'm Sami — a software engineer who builds data platforms and AI tooling. Right now I'm at Stackdrop, working with Wayve on workforce and fleet systems and shipping data products for clients across the stack.",
